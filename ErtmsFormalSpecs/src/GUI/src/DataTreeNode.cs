...
namespace GUI
{
    ...
    public abstract class BaseTreeNode : TreeNode, IComparable<BaseTreeNode>
    {
        ...
        public virtual void BuildOrRefreshSubNodes(IModelElement modifiedElement)
        {
            ...
            {
                bool refreshNode = node.Model.IsParent(modifiedElement) || node.SubNodesBuilt || IsExpanded;
        ...
        protected virtual List<MenuItem> GetMenuItems()
        {
            ...
            newItem.MenuItems.Add(new MenuItem("Enforce naming convention", CheckNaming));
            retVal.Add(newItem);
