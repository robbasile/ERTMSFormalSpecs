...
namespace ErtmsSolutions.Etcs.Subset26.BrakingCurves
{
    public class EtcsBrakingData
    {
        ...
        {
            return Interpolate(someV, Params.dV_warning_min, Params.dV_warning_max, Params.V_warning_min,
                Params.V_warning_max);
        }
    }
}